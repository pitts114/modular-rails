...
RSpec.describe Arbius::ContestationSubmittedEvent, type: :model do
  let(:event_detail) { create(:arbius_ethereum_event_detail) }
  subject { described_class.new(arbius_ethereum_event_details_id: event_detail.id, address: '0xabc', task: 'task1') }
